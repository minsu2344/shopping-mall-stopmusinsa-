                        ...
                        <div class="HeaderMain__right">
                            <nav class="HeaderMainNav">
                                <ul class="HeaderMainNav__list">
                                    ...
                                    <li class="HeaderMainNavItem">
                                        <a class="HeaderMainNavItem__link" href="#">상의</a>
                                    </li>
                                    <li class="HeaderMainNavItem">
                                        <a class="HeaderMainNavItem__link" href="#">바지</a>
                                    </li>
                                    <li class="HeaderMainNavItem">
                                        <a class="HeaderMainNavItem__link" href="#">아우터</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
                    ...
                    <div class="HeaderMember__container Site__container">
                        ...
                        <div class="HeaderMemberMenus">
                            <div class="HeaderMemberMenu">
                                <a class="HeaderMemberMenu__link" href="#">회원가입</a>
                            </div>
                            <div class="HeaderMemberMenu">
                                <a class="HeaderMemberMenu__link" href="#">장바구니</a>
                                <span class="HeaderMemberMenu__badge">0</span>
                            </div>
                            <div class="HeaderMemberMenu">
                                <a class="HeaderMemberMenu__link" href="#">회원 가입 EVENT. 신규 가입 후 바로 사용 가능한 18% 할인 쿠폰 / 게섯거라 스탠다드 990원 구매 기회</a>
                            </div>
                        </div>
                    </div>
                </div>
