...
categorytRouter.post('/', loginRequired, async (req, res, next)=>{
  try {
    if (req.currentUserRole!=='admin') {
      throw new Error('관리자만 사용 가능한 기능입니다.');
    }
...
categorytRouter.post('/color', loginRequired, async (req, res, next)=>{
  try {
    if (req.currentUserRole!=='admin') {
      throw new Error('관리자만 사용 가능한 기능입니다.');
    }
...
categorytRouter.post('/size', loginRequired, async (req, res, next)=>{
  try {
    if (req.currentUserRole!=='admin') {
      throw new Error('관리자만 사용 가능한 기능입니다.');
    }
...
categorytRouter.patch('/main/:categoryName', loginRequired, async (req, res, next)=>{
  try {
    if (req.currentUserRole!=='admin') {
      throw new Error('관리자만 사용 가능한 기능입니다.');
    }
...
categorytRouter.patch('/sub', loginRequired, async (req, res, next)=>{
  try {
    if (req.currentUserRole!=='admin') {
      throw new Error('관리자만 사용 가능한 기능입니다.');
    }
...
categorytRouter.patch('/color/:colorId', loginRequired, async (req, res, next)=>{
  try {
    if (req.currentUserRole!=='admin') {
      throw new Error('관리자만 사용 가능한 기능입니다.');
    }
...
categorytRouter.patch('/size/:sizeId', loginRequired, async (req, res, next)=>{
  try {
    if (req.currentUserRole!=='admin') {
      throw new Error('관리자만 사용 가능한 기능입니다.');
    }
...
categorytRouter.delete('/:categoryId', loginRequired, async (req, res, next)=>{
  try {
    if (req.currentUserRole!=='admin') {
      throw new Error('관리자만 사용 가능한 기능입니다.');
    }
...
categorytRouter.delete('/color/:colorId', loginRequired, async (req, res, next)=>{
  try {
    if (req.currentUserRole!=='admin') {
      throw new Error('관리자만 사용 가능한 기능입니다.');
    }
...
categorytRouter.delete('/size/:sizeId', loginRequired, async (req, res, next)=>{
  try {
    if (req.currentUserRole!=='admin') {
      throw new Error('관리자만 사용 가능한 기능입니다.');
    }
